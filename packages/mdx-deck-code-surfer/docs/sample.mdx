...
<CodeSurfer
  title={() => <h1 style={{background: "pink"}}>Use Render Props</h1>}
  notes={() => <span style={{background: "pink"}}>For title or notes</span>}
...
[(demo source)](https://github.com/pomber/code-surfer/blob/master/packages/mdx-deck-code-surfer/docs/sample.mdx)
